...
```{r}
microbenchmark(brute_force_knapsack(x = knapsack_objects[1:8,], W = 3500), times = 5)
...
```{r}
microbenchmark(knapsack_dynamic(x = knapsack_objects[1:8,], W = 3500), times = 5)
# RUN BEFORE SUBMITTING: 
...
microbenchmark(greedy_knapsack(x = knapsack_objects[1:8,], W = 3500), times = 5)
```
